...
export default function DemoPage() {
    ...
    // Fallback name if param missing (or nice capitalization)
    ...
    return (
        <div className="min-h-screen bg-black text-white selection:bg-indigo-500/30">
            {/* Fake Header */}
            <header className="fixed top-0 left-0 right-0 z-40 h-20 border-b border-white/5 bg-black/50 backdrop-blur-md flex items-center justify-between px-6 md:px-12">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        ...
                        <span className="text-[10px] uppercase tracking-widest text-indigo-400">Official Website</span>
                    </div>
                </div>
            ...
            <main className="pt-32 pb-20 px-6 md:px-12 flex flex-col items-center justify-center min-h-[80vh] text-center relative overflow-hidden">
                ...
                >
                    ...
                    <p className="text-lg md:text-xl text-white/50 max-w-2xl mx-auto leading-relaxed">
                        {isRtl
                            ? "هذي صفحة تجريبية تم إنشاؤها تلقائياً. جرب الشات بوت الذكي تحت عشان تشوف كيف نخدم ضيوفك."
                            : "This is an auto-generated demo page. Check the smart chatbot below to see how we serve your guests instantly."}
                    </p>
                ...
                >
                    <div className="flex items-center gap-4">
                        <span className="text-white/60 font-handwriting text-xl transform -rotate-12">Try me!</span>
